...
mongoose.connect("mongodb+srv://admin:ogMUXixqITk2lerg@cluster0.ut3oc8b.mongodb.net/?retryWrites=true&w=majority").then(() => console.log("Connected to the Database")).then(() => {
    app.listen(5000);
}).catch((err) =>console.log(err));